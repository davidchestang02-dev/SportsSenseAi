...
CREATE TABLE IF NOT EXISTS mlb_odds (
  ...
  provider_name TEXT,
  provider_id TEXT,
  provider_logo_light TEXT,
  provider_logo_dark TEXT,
  provider_deep_link TEXT,
  home_team_abbr TEXT,
  away_team_abbr TEXT,
  favorite TEXT,
  underdog TEXT,
  ...
  spread_home_open_line REAL,
  spread_home_open_odds REAL,
  spread_home_close_line REAL,
  spread_home_close_odds REAL,
  spread_home_current_line REAL,
  spread_home_current_odds REAL,
  spread_away_open_line REAL,
  spread_away_open_odds REAL,
  spread_away_close_line REAL,
  spread_away_close_odds REAL,
  spread_away_current_line REAL,
  spread_away_current_odds REAL,
  total_over_open_line REAL,
  total_over_open_odds REAL,
  total_over_close_line REAL,
  total_over_close_odds REAL,
  total_over_current_line REAL,
  total_over_current_odds REAL,
  total_under_open_line REAL,
  total_under_open_odds REAL,
  total_under_close_line REAL,
  total_under_close_odds REAL,
  total_under_current_line REAL,
  total_under_current_odds REAL,
  raw_payload TEXT
);
